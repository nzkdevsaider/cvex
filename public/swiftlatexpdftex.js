...
var _compileLaTeX = (Module["_compileLaTeX"] = function () {
  return (_compileLaTeX = Module["_compileLaTeX"] = Module["asm"]["Q"]).apply(
    null,
    arguments,
  );
});
var _compileFormat = (Module["_compileFormat"] = function () {
  return (_compileFormat = Module["_compileFormat"] = Module["asm"]["R"]).apply(
    null,
    arguments,
  );
});
var _compileBibtex = (Module["_compileBibtex"] = function () {
  return (_compileBibtex = Module["_compileBibtex"] = Module["asm"]["S"]).apply(
    null,
    arguments,
  );
});
var _setMainEntry = (Module["_setMainEntry"] = function () {
  return (_setMainEntry = Module["_setMainEntry"] = Module["asm"]["T"]).apply(
    null,
    arguments,
  );
});
